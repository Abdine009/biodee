...
<form action="" method="post">
        @csrf
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control @error('email', 'login') is-invalid @enderror " id="email" placeholder="Entrez votre email" value="{{old('email')}}">
                @error("email")
            ...
            <div class="mb-3">
                ...
                <input type="password" name = "password" class="form-control @error('password', 'login') is-invalid @enderror" id="password" placeholder="Entrez votre mot de passe" >
                @error("password")
                <div class="alert alert-danger mt-2">{{ $message }}</div>
                @enderror
                <!-- @error('password')
